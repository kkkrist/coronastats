...
## <small>1.22.10 (2021-10-03)</small>

* fix(crawler/ks): adapt selectors ([8ef39e3](https://github.com/kkkrist/coronastats/commit/8ef39e3))





## <small>1.22.9 (2021-09-27)</small>

* fix(crawler/ks): fix date matcher ([0698141](https://github.com/kkkrist/coronastats/commit/0698141))
...
## <small>1.21.11 (2021-06-11)</small>

* fix(crawler/ks): tweak date regex ([3a49a41](https://github.com/kkkrist/coronastats/commit/3a49a41))
...
## <small>1.21.6 (2021-05-05)</small>

* fix(crawler/l): adapt selectors ([32aff6e](https://github.com/kkkrist/coronastats/commit/32aff6e))





## <small>1.21.5 (2021-05-03)</small>

* fix(crawler/row): update date regex ([4c085b2](https://github.com/kkkrist/coronastats/commit/4c085b2))
...
* chore(README): update ([d2990ea](https://github.com/kkkrist/coronastats/commit/d2990ea))
...
* fix(README): add "Landkreis Rotenburg" to area list ([04b025f](https://github.com/kkkrist/coronastats/commit/04b025f))
